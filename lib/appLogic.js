...
export async function initApp(){
  ...
  function syncStationsToSteps(id){
    ...
    // ถ้าสถานี "ว่าง" หรือช่องเปล่าคั่นกลาง loop ด้านบนจะข้าม index นั้นไป
    // ทำให้เกิดรู (undefined) ใน array — บีบให้แน่นก่อน ไม่งั้น JSON.stringify แปลงเป็น null
    ed.steps = ed.steps.filter(s => s != null);
